...
<% HashMap<String, String> parms = (HashMap<String, String>)session.getAttribute("parms");
 %><p>The alert was sent to your e-mail address: <%= parms.get("editorEmail") %></p>
...
<table><tr>
 ...
 <td><form method="post" action="EditController" name="publishAlertButton">
  <input name="editStep" value="publishAlert" type="hidden" />
  <input type="submit" value="Publish this approved alert" />
</form>
</td>
